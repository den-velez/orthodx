...
import { privacy } from "@/constants/termsAndCondionts";

export default function PrivacyPage() {
  return (
    <main className='py-10 bg-bgDark-090 text-txtBrand-alternative'>
      <h1 className='mb-10 text-h1 text-center'>Aviso de Privacidad</h1>
      <div className='flex flex-col gap-6 px-4'>
        {privacy.details.map((item, index) => (
          <div key={index}>
