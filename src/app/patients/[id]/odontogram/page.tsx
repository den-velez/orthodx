...
const odontogramUpItems = [
  {
    ...
    styles:
      "absolute w-12 h-10 right-[calc(50%+140px)] top-[210px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "17",
    ...
    styles:
      "absolute w-12 h-10 right-[calc(50%+130px)] top-[170px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "16",
    ...
    styles:
      "absolute w-12 h-10 right-[calc(50%+120px)] top-[130px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "15",
    ...
    styles:
      "absolute w-11 h-10 right-[calc(50%+110px)] top-[95px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "14",
    ...
    styles:
      "absolute w-11 h-10 right-[calc(50%+96px)] top-[60px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "13",
    ...
    styles:
      "absolute w-10 h-10 right-[calc(50%+75px)] top-[30px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "12",
    ...
    styles:
      "absolute w-10 h-10  right-[calc(50%+40px)] top-[10px]   rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "11",
  ...
  },
  {
    ...
    statusStyles: STATUS_STYLES.cariesLingual.upper,
    styles:
      "absolute -scale-x-[1] w-10 h-10  left-[calc(50%+40px)] top-[10px]   rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "23",
    image: "/images/odontogram/s3.png",
    statusStyles: STATUS_STYLES.cariesDistal.upper,
    styles:
      "absolute -scale-x-[1] w-10 h-10 left-[calc(50%+75px)] top-[30px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "24",
    image: "/images/odontogram/s4.png",
    statusStyles: STATUS_STYLES.cariesMesial.upper,
    styles:
      "absolute -scale-x-[1] w-11 h-10 left-[calc(50%+96px)] top-[60px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "25",
    image: "/images/odontogram/s5.png",
    statusStyles: STATUS_STYLES.cariesOclusal,
    styles:
      "absolute -scale-x-[1] w-11 h-10 left-[calc(50%+110px)] top-[95px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "26",
    image: "/images/odontogram/s6.png",
    statusStyles: STATUS_STYLES.obturacion,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+120px)] top-[130px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "27",
    image: "/images/odontogram/s7.png",
    statusStyles: STATUS_STYLES.corona,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+130px)] top-[170px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "28",
    image: "/images/odontogram/s8.png",
    statusStyles: STATUS_STYLES.ausente,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+140px)] top-[210px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
];
...
const odontogramDownItems = [
  {
    ...
    statusStyles: STATUS_STYLES.ausente,
    styles:
      "absolute w-12 h-10 right-[calc(50%+130px)] bottom-[230px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "47",
    ...
    statusStyles: STATUS_STYLES.corona,
    styles:
      "absolute w-12 h-10 right-[calc(50%+120px)] bottom-[185px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "46",
    ...
    statusStyles: STATUS_STYLES.obturacion,
    styles:
      "absolute w-12 h-10 right-[calc(50%+110px)] bottom-[140px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "45",
    ...
    statusStyles: STATUS_STYLES.cariesOclusal,
    styles:
      "absolute w-11 h-10 right-[calc(50%+100px)] bottom-[95px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "44",
    ...
    styles:
      "absolute w-11 h-10 right-[calc(50%+86px)] bottom-[60px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "43",
    ...
    styles:
      "absolute w-10 h-10 right-[calc(50%+65px)] bottom-[30px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "42",
  ...
  },
  {
    ...
    styles:
      "absolute w-9 h-10 right-[50%]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "31",
    image: "/images/odontogram/i1.png",
    statusStyles: STATUS_STYLES.cariesVestibular.lower,
    styles:
      "absolute -scale-x-[1] w-9 h-10 left-[50%]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "32",
    image: "/images/odontogram/i2.png",
  ...
  },
  {
    ...
    statusStyles: STATUS_STYLES.cariesDistal.lower,
    styles:
      "absolute -scale-x-[1] w-10 h-10 left-[calc(50%+65px)] bottom-[30px]  rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "34",
    image: "/images/odontogram/i4.png",
  ...
  },
  {
    ...
    statusStyles: STATUS_STYLES.cariesOclusal,
    styles:
      "absolute -scale-x-[1] w-11 h-10 left-[calc(50%+100px)] bottom-[95px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "36",
    image: "/images/odontogram/i6.png",
    statusStyles: STATUS_STYLES.obturacion,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+110px)] bottom-[140px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "37",
    image: "/images/odontogram/i7.png",
    statusStyles: STATUS_STYLES.corona,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+120px)] bottom-[185px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
  {
    label: "38",
    image: "/images/odontogram/i8.png",
    statusStyles: STATUS_STYLES.ausente,
    styles:
      "absolute -scale-x-[1] w-12 h-10 left-[calc(50%+130px)] bottom-[230px] rounded-full hover:border hover:border-cta-100 hover:border-4",
  },
];
